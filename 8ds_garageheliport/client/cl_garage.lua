...
-- Menu --
local open = false 
local MenuGarage = RageUI.CreateMenu("Garage Hélicoptère", "INTERACTION")
...
RegisterNetEvent("helico:OpenGarageMenu") AddEventHandler("helico:OpenGarageMenu", function() OpenMenuGarage() end)